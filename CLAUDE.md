...
- **`0004_approve_draft.sql` still outstanding** — unblocked by task 7 per amendment A1; must land before task 13. Then task 9 (`extract-facts` + the four-layer evidence enforcement).
