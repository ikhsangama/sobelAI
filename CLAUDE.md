...
- **`0005_approve_draft.sql` still outstanding** — unblocked by task 7 per amendment A1; must land before task 13. Then task 12 (the eval harness — the fastest debugger for this orchestration, and one of the two deliverables §11 calls uncuttable).
