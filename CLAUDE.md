...
- **`0005_approve_draft.sql` still outstanding** — unblocked by task 7 per amendment A1 (renumbered again, see A1); must land before task 13. Then task 10 (`ingest-inbound` + opt-out/snooze detection).
